...
from candle.rooms.search import get_room, get_rooms_sorted_by_dashes, search_rooms
...
def listing():
    ...
    rooms_dict = get_rooms_sorted_by_dashes(
        room_list
    )  # rooms are in the dictionary sorted by prefix
    title = "Rozvrhy miestností"
    return render_template(
        "rooms/listing.html", rooms_dict=rooms_dict, title=title, web_header=title
    )
